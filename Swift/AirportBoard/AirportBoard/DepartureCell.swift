...
//
// MARK: - Departure cell display settings
...
final class DepartureCell: UITableViewCell {
	...
	/// Passing data from the Departure Cell to the transition method
	...
	// MARK: - Reusing a cell in the Departure List for scrolling
	...
	func updateCell(flight: Flight) {
		...
		time.text = timeFormat.timeInString(time: flight.departure ?? "Unknown")
	}
...
private extension DepartureCell {
	...
	/// Method for moving from Departure Cell to FlightDetails
	@objc func tapCell() {
